    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('users.show', ['user' => Auth::user()->id])" :active="request()->routeIs('users.show')">
                        {{ __('Mis datos') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('user.reserva')" :active="request()->routeIs('user.reserva')">
                        {{ __('Reservar Cita') }}
                    </x-nav-link>
                </div>
